  ...
  return (
    <footer className="px-4 pt-5 lg:pt-20 pb-5 text-white">
      <div className="max-w-7xl mx-auto flex flex-col gap-2 lg:gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <div className="col-span-1 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-5 lg:gap-10">
            ...
            <div className="max-w-lg">
              ...
              <p className="text-gray-500 text-xs mt-2">Visit us at: <a href="https://casino-4-five.vercel.app/"><span className="gold">casino</span></a></p>
            </div>
          </div>
        ...
        <div className=" bg-gray-800/50 rounded-lg border border-gray-700/30 p-4 mb-6">
          <div className="text-center text-[14px]">
            <h4 className="text-[#DDA435] font-bold text-lg mb-3">IMPORTANT DISCLAIMER</h4>
